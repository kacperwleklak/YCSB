cd ..
start cmd /k .\bin\ycsb run redblue -p redblue.url=jdbc:postgresql://localhost:5433/postgres,jdbc:postgresql://localhost:5434/postgres,postgresql://localhost:5435/postgres ^
